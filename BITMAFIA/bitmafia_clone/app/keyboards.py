...
def kb_admin_panel(commission_percent: float) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text="Все о крипте", callback_data="admin:set_link:faq"),
            ...
            [
                ...
                InlineKeyboardButton(text="Поддержка", callback_data="admin:set_link:operator"),
            ],
            [InlineKeyboardButton(text="Миксер BTC", callback_data="admin:set_link:exchange")],

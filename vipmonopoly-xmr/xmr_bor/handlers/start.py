...
async def send_start(message: types.Message, edit: bool = False):
    ...
    kb.button(text="⚡ Купить XMR ⚡", callback_data="buy_XMR")
    ...
    caption = (
        "<b>Бот обменник</b>\n\n"
        "Тут ты можешь обменять свои <b>RUB</b> на <b>XMR</b>\n\n"
        'Жми кнопку <b>"👉🏻 Купить XMR 👈🏻"</b> или просто введи сумму в <b>RUB</b> или <b>XMR</b>\n\n'
